...
namespace RFG.SceneGraph
{
  ...
  public class SceneGraphManager : Singleton<SceneGraphManager>
  {
    ...
    private void Start()
    {
      ...
      if (NextSceneTransition.autoLoadWaitTime > 0)
      {
    ...
    {
      if (NextSceneTransition == null || !NextSceneTransition.anyInput || _hasSkipped)
        return;
    ...
    {
      yield return new WaitForSecondsRealtime(NextSceneTransition.autoLoadWaitTime);
      LoadNextScene();
    }
